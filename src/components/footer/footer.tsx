        ...
        <footer dir='rtl' className="w-full bg-greenishBlue font-Lalezar">
            <div className="flex flex-col items-center justify-between w-11/12 gap-10 m-auto md:flex md:flex-row">
                <div className="flex flex-col items-start py-5">
                    ...
                    <p className="text-lg text-white font-WYekan">بامبو یکی از پرتلاش‌ترین و بروزترین وبسایت های آموزشی در سطح ایران
                ...
                <div className="flex flex-col py-5">
                    ...
                    <div className="flex flex-col sm:flex sm:flex-row">
                        <input className="w-full px-2 text-white border-none outline-none font-WYekan bg-footerBg h-9" type="email" placeholder="ایمیل خود را وارد کنید ..." />
            ...
            <div className='flex flex-col font-WYekan items-center justify-between w-11/12 gap-10 m-auto mt-2 sm:flex sm:flex-row'>
