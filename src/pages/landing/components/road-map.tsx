  ...
  return (
    <section className={`w-full h-[100vh] flex flex-col bg-blue-400`}>
      <div className="grow bg-[#004458] flex flex-row ">
        ...
        <article className={`flex flex-col justify-center grow max-[1255px]:w-1/2 max-[560px]:hidden `} >
      ...
      <div className={styles.gradient}>
        <article className={`flex flex-col justify-center max-[560px]:w-full max-[1255px]:w-1/2 `} >
      ...
      <div
        ...
        <article className={`flex flex-col justify-center grow max-[1255px]:w-1/2  max-[560px]:w-full`} >
