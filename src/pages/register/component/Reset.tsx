            ...
            <div className='w-100 h-auto'>
                <div className='flex flex-col items-center justify-center w-1/2 h-auto m-auto overflow-hidden bg-white rounded shadow-lg md:w-full md:flex-row'>
                    <div className='relative w-full h-full md:block'>
                        ...
                        <Link to={"/register/login"}><div className="absolute flex items-center justify-center w-10 h-10 border-2 border-white border-solid rounded-full cursor-pointer top-4 right-4">
                    ...
                    <div className='relative flex flex-col justify-between w-full h-full mx-5 animate-slideUp md:w-2/3'>
                        ...
                        <form className='flex flex-col items-center justify-between mx-5 py-2'>
                            <input type="email" className='w-full px-1 py-2 mb-2 bg-gray-100 rounded-sm outline-none focus:border-b-2 focus:border-greenishBlue placeholder:text-xs' placeholder='ایمیل:' />
                            <button className='px-4 py-2 my-4 text-center text-sm text-white transition duration-500 border border-transparent rounded cursor-pointer bg-greenishBlue hover:bg-gray-200 hover:text-black hover:border-greenishBlue'>ارسال ایمیل</button>
                            <span className='my-2 text-xs text-center'>به زودی برای شما یک لینک بازنشانی ارسال خواهد شد</span>
                        </form>
                    </div>
                </div>
            </div>
