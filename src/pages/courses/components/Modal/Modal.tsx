    ...
    return (
        <div>
            <div
                ...
                onClick={onclick}
            />
            <div className="animate-showingup sm:tracking-wider font-Lalezar z-100 text-[#3E7788] h-full
      overflow-y-auto overflow-x-hidden ">
                <div className=" p-6 flex fixed flex-col gap-4  text-right max-w-[450px] w-full  bg-white shadow-xl
          ...
          >
            x
                    ...
                    <div className="w-24 h-24 sm:w-40 sm:h-36 top-6 left-6 absolute flex-none bg-current">
                        <img
                            src={require("../../../../../public/assets/" + modal.srcImage + ".jpg")}
                            alt={modal.altName}
