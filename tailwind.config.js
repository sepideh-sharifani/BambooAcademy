  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        license:
          "url('./assets/young-handsome-curly-student-man-with-notebooks-isolated-white-wall.png')",
        construction:
          "url('./assets/cheerful-mood-group-people-business-conference-modern-classroom-daytime.png')",
